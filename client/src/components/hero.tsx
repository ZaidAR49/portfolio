        ...
        <div className="hero min-h-screen animate-in fade-in slide-in-from-bottom duration-700 -mt-16 ">
          ...
          >
            <div className="max-w-md ">
              <h1 className="header-primary text-4xl sm:text-5xl lg:text-6xl">
                Hi, I'm <br /> {userInfo.name}
              </h1>
              <p className="py-6">
                I'm a passionate <strong>Software Engineer</strong>{" "}
                {userInfo.descHero}
              </p>
              <div
          ...
          <div className="flex-col gap-0 justify-center max-w-lg mx-auto sm:mt-10 -mt-10 px-4 lg:px-0">
            <div className="carousel carousel-center rounded-box opacity-60 my-10 w-full">
              {userInfo.techIcons.map((tech, index) => (
                <div
                  key={index}
                  className="carousel-item w-20 h-20 sm:w-24 sm:h-24 flex flex-col items-center justify-center"
                >
            ...
            <div className="text-3xl sm:text-4xl opacity-60 grid place-items-center -mt-12 mb-12  ">
              <div>...</div>
            </div>
          </div>
        </div>
