...
app.post('/api/contact', (req, res) => {
    ...
    const emailBodyTouser=`<div style="max-width:600px; margin:auto; font-family:Arial, sans-serif; background-color:#000; color:#fff; padding:20px; border-radius:10px; box-shadow:0 0 10px rgba(0,0,0,0.5);">
  ...
  <div style="background:#111; padding:15px; border-radius:8px;">
    ...
    <p style="color:#eee;">Best regards,<br />Zaid Radaideh</p>
       <a href="https://zar.onrender.com" style="display:inline-block; background:rgb(6,182,212); border-radius:5px; color:#fff; padding:12px 20px; text-decoration:none; font-weight:bold;">Go Back to Portfolio</a>
